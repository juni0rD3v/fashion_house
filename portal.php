...
<header class="masthead">
	<div class="container">
		<div class="masthead-subheading pt-2">Welcome To ZIR AA Fashion House</div>
		<!-- <div class="masthead-heading text-uppercase">Explore our Tour Packages</div> -->
		<a class="btn btn-primary btn-xl text-uppercase" href="#home">View Apparel</a>
	</div>
</header>
<!-- Services-->
<section class="page-section bg-dark" id="home">
	...
	<div class="d-flex w-100 justify-content-end">
		<a href="./?page=packages" class="btn btn-flat btn-dark mr-4">See More <i class="fa fa-arrow-right"></i></a>
	</div>
	</div>
</section>
<!-- About-->
