...
<script>
        ...
        $.ajax({
            ...
            success:function(resp){
                if(typeof resp == 'object' && resp.status == 'success'){
                    alert_toast("reservation cancelled successfully",'success')
                    setTimeout(function(){
                        location.reload()
                    },2000)
                }else{
    ...
    $(function(){
        ...
        $('.view_data').click(function(){
            uni_modal("Reservation Information","./view_reservation.php?id="+$(this).data('id'))
        })
        $('table').dataTable();
    })
</script>
