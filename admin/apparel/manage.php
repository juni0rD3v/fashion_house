...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?>Apparel</h3>
	</div>
	<div class="card-body">
		<form action="" id="package-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="title" class="control-label">Apparel Title</label>
                <textarea name="title" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($title) ? $title : ''; ?></textarea>
			</div>
            <div class="form-group">
				<label for="tour_location" class="control-label">Apparel User</label>
           ...
           <!-- <div class="row">
                <div class="form-group col-6">
                    <label for="tour_location" class="control-label">Color</label>
                    <textarea name="tour_location" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($tour_location) ? $tour_location : ''; ?></textarea>
                </div>
                <div class="form-group col-6">
                    <label for="tour_location" class="control-label">Size</label>
                    <textarea name="tour_location" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($tour_location) ? $tour_location : ''; ?></textarea>
                </div>
           </div> -->
            <div class="form-group">
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=apparel">Cancel</a>
	</div>
</div>
<script>
