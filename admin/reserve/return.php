	...
	<div class="card-body">
        ...
        <table class="table table-stripped text-dark">
            ...
            <tbody>
                <?php 
                $i=1;
                    $qry = $conn->query("SELECT b.*,p.title,concat(u.firstname,' ',u.lastname) as name FROM book_list b inner join `packages` p on p.id = b.package_id inner join users u on u.id = b.user_id where b.status= 4 order by date(b.date_created) desc ");
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <?php elseif($row['status'] == 3): ?>
                                <span class="badge badge-navy">Picked</span>
...
<script>
	$(document).ready(function(){
        ...
        $('.view_data').click(function(){
            uni_modal("Reservation Information","reserve/view.php?id="+$(this).attr('data-id'))
        })
		$('.table').dataTable();
	})
